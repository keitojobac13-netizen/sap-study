...
const MODULE_STYLES: Record<ModuleKey, { badge: string; text: string; bg: string; border: string }> = {
  ...
  abap:  { badge: 'bg-red-600',     text: 'text-red-700',     bg: 'bg-red-50',     border: 'border-red-200' },
  basis: { badge: 'bg-amber-600',   text: 'text-amber-700',   bg: 'bg-amber-50',   border: 'border-amber-200' },
  ps:    { badge: 'bg-teal-600',    text: 'text-teal-700',    bg: 'bg-teal-50',    border: 'border-teal-200' },
};

const MODULE_KEYS: ModuleKey[] = ['fi', 'co', 'sd', 'mm', 'pp', 'abap', 'basis', 'ps'];
